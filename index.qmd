...
- **datasets**: which accessible (i.e., public or registered access) datasets is the method evaluated on in the respective paper?
...
hide_cols <- c('authors', 'year', 'multiple losses', 'datasets', 'simulation')
